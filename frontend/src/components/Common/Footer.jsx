      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/faq" className="hover:text-blue-600 dark:hover:text-blue-400 transition">
                  FAQ
                </Link>
              </li>
              <li>
                <Link to="/help" className="hover:text-blue-600 dark:hover:text-blue-400 transition">
                  Help Center
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-200 dark:border-gray-800 pt-8 mb-8">
          <div className="max-w-md mx-auto text-center">
            ...
            <form className="flex flex-col sm:flex-row gap-2">
              ...
              <button
                type="submit"
                className="px-6 py-2 bg-gray-800 dark:bg-white text-white dark:text-black rounded-lg hover:bg-gray-700 dark:hover:bg-gray-200 transition"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="border-t border-gray-200 dark:border-gray-800 pt-8 flex flex-col sm:flex-row justify-between items-center text-sm">
          <p className="opacity-80">
            © {currentYear} MeroByapar. All rights reserved.
          </p>
